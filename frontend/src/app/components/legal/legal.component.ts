...
export class LegalComponent implements OnInit {
  ...
  tabs: { id: LegalTab; label: string; iconClass: string }[] = [
    { id: 'privacy',  label: 'Privacy Policy',   iconClass: 'bi bi-lock-fill' },
    { id: 'terms',    label: 'Terms of Service',  iconClass: 'bi bi-file-earmark-text-fill' },
    { id: 'cookies',  label: 'Cookie Policy',     iconClass: 'bi bi-cookie' },
    { id: 'sitemap',  label: 'Sitemap',           iconClass: 'bi bi-sitemap' },
  ];
